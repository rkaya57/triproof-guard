...
export const metadata = {
  title: "ScamGuard Web3 Shield | Chrome Extension | Tri-Proof Protocol",
  description:
    "Install the official ScamGuard Web3 Shield from the Chrome Web Store and bring Tri-Proof risk context into supported Web3 browsing and signing flows.",
}
      ...
      <section className="security-grid border-b border-border">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
          <div className="mb-5 flex flex-wrap items-center gap-2">
            <Badge variant="secondary" className="w-fit border-emerald-400/30 bg-emerald-400/10 text-emerald-200">
              <Puzzle className="size-3.5" /> Live on Chrome Web Store
            </Badge>
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-muted-foreground">
            ScamGuard Web3 Shield is the official Chrome extension for the Tri-Proof security platform. It helps users review suspicious Web3 pages and signing context without taking custody of wallets or assets.
          </p>
          ...
          <div className="mt-6 max-w-3xl rounded-xl border border-emerald-400/20 bg-emerald-400/[0.055] p-4 text-sm leading-6 text-slate-300">
            Official distribution is now handled through the Chrome Web Store. Use the store listing above for normal installation and future extension updates.
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="mb-9 max-w-3xl">
          ...
          <p className="mt-4 leading-7 text-muted-foreground">
            The Chrome extension complements the web scanner and Telegram bot. It is an access channel for the same ScamGuard security engine, not a separate custody or wallet product.
          </p>
        </div>
      ...
      <section className="border-y border-border bg-primary/[0.03]">
        <div className="mx-auto grid max-w-7xl gap-7 px-5 py-16 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="text-3xl font-semibold sm:text-4xl">Install from Chrome Web Store. Confirm account links on Tri-Proof.</h2>
            <p className="mt-4 leading-7 text-muted-foreground">
              A valid extension request opens the protected Tri-Proof connection page with a request identifier. After sign-in, the user confirms the account link. Opening the connection route without a valid request does not grant extension access.
            </p>
          </div>
          <Card className="glass-panel premium-card border-primary/35 bg-primary/5">
            <CardContent className="grid gap-4 p-6">
              {[
                "Install ScamGuard Web3 Shield from the official Chrome Web Store listing.",
                "Start the connection from the installed extension.",
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Card className="border-yellow-400/25 bg-yellow-400/5">
            <CardHeader>
              ...
              <CardDescription className="leading-7">
                Seed phrases, private keys, wallet passwords, or permission to move assets. Report any package or page that asks for them while claiming to be ScamGuard.
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/docs" className={buttonVariants({ variant: "outline" })}>
            Read security documentation <ArrowRight data-icon="inline-end" />
          </Link>
        </div>
      </section>
    </main>
