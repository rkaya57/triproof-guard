  ...
  return (
    <LegalPageLayout eyebrow="Privacy policy" title="Privacy without a custody blind spot." summary="This policy describes the information Tri-Proof Guard processes when you use the website, ScamGuard, Sybil analysis, Telegram Guardian, and B2B API services.">
      ...
      <ul>
        ...
        <li><strong>ScamGuard and extension activity:</strong> URLs of supported pages opened while ScamGuard is active, user-triggered page links, domains, public wallet addresses when available, token or contract identifiers, and wallet-request data supplied by a dApp for decoding. We process this information to identify phishing, impersonation, approval, and transaction risks. The extension stores its recent decision history, settings, and observed approval-request ledger locally in the browser unless you explicitly use a server-backed product feature.</li>
