    ...
    <main className="premium-page min-h-screen overflow-hidden bg-background text-foreground">
      <section className="security-grid relative overflow-hidden border-b border-border">
        <div aria-hidden className="pointer-events-none absolute inset-0">
          ...
          <div className="glow-orb bottom-[-10rem] left-1/3 size-96" style={{ background: "var(--guard-cyan)", opacity: 0.28, animationDelay: "5s" }} />
        </div>
        ...
        <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
          <Link href="/" className="group flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.22em] text-primary/80">Contact</span>
            </div>
          </Link>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-10 sm:px-8 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:pb-24 lg:pt-20">
          <div className="reveal-up flex flex-col gap-7">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Badge variant="secondary" className="border-primary/30 text-primary">Support & partnerships</Badge>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link href="/docs" className={`${buttonVariants({ variant: "outline", size: "lg" })} hover-lift`}>Read docs</Link>
            </div>
          </div>
          ...
          <div className="glass-panel premium-card animated-border data-scan relative rounded-3xl p-6 reveal-up delay-200">
            <div className="mb-6 flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Use the right inbox for faster routing</p>
              </div>
            ...
            <div className="grid gap-4">
              {contactCards.map((card, index) => {
                ...
                return (
                  <Card key={card.email} className="glass-panel premium-card hover-lift reveal-up" style={{ animationDelay: `${index * 0.08}s` }}>
                    <CardHeader>
                    ...
                    <CardContent>
                      <p className="mb-4 break-all font-mono text-sm text-primary">{card.email}</p>
                      <a href={card.href} className={buttonVariants({ variant: "outline" })}>{card.cta}</a>
                    </CardContent>
                  </Card>
                )
              })}
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-5 py-16 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:py-20">
        <div className="reveal-up">
          ...
          <div className="mt-6 rounded-2xl border border-primary/25 bg-primary/10 p-5 text-sm leading-6 text-muted-foreground">
            For partnerships and ecosystem collaborations, contact <span className="font-mono text-primary">sdemirbozan@triproofprotocol.com</span> directly.
          </div>
        </div>

        <Card className="glass-panel premium-card animated-border reveal-up delay-200">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><MessageSquare className="text-primary" /> What to include</CardTitle>
            <CardDescription>Copy these details into your email for a faster reply.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
              ...
              <a href="mailto:sdemirbozan@triproofprotocol.com?subject=Tri-Proof%20Partnership%20Inquiry" className={buttonVariants({ variant: "outline" })}><Handshake data-icon="inline-start" /> Partnership inquiry</a>
            </div>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="border-y border-border bg-primary/[0.03]">
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-20">
          <div className="mb-10 max-w-3xl">
            ...
            <p className="mt-4 text-muted-foreground">Choose the message type that best matches your request so it can be routed correctly.</p>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-24">
        <div className="glass-panel premium-card animated-border rounded-3xl p-8 text-center reveal-up">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">Let’s discuss how Tri-Proof Guard can help your team review wallet lists before rewards are sent.</p>
          <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a href="mailto:info@triproofprotocol.com?subject=Tri-Proof%20Support" className={`${buttonVariants({ variant: "outline", size: "lg" })} hover-lift`}><Headphones data-icon="inline-start" /> Product support</a>
          </div>
        </div>
      </section>
    </main>
