...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl border border-border/70 bg-card/92 py-(--card-spacing) text-sm text-card-foreground shadow-[0_18px_48px_rgb(0_0_0_/_0.18),inset_0_1px_0_rgb(255_255_255_/_0.025)] backdrop-blur-sm transition-[border-color,box-shadow,transform] duration-200 [--card-spacing:--spacing(4)] hover:border-primary/18 hover:shadow-[0_24px_58px_rgb(0_0_0_/_0.22),inset_0_1px_0_rgb(255_255_255_/_0.035)] has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)] data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-2xl *:[img:last-child]:rounded-b-2xl",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-border/60 bg-muted/32 p-(--card-spacing)",
        className
      )}
      {...props}
    />
